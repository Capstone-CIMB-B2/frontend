        ...
        Positioned(
          ...
          child: Column(
            children: [
              SizedBox(
                height: 280,
                child: Image.asset('assets/background/bg-beranda.png',
                      ...
                      Padding(
                        ...
                        child: RichText(
                          text: const TextSpan(
                            ...
                            children: [
                              TextSpan(text: 'Selamat siang, ', style: TextStyle(fontWeight: FontWeight.w400)),
                              TextSpan(text: 'Apa Kabar?', style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              _MenuGrid(tabIndex: _selectedTab, isLoggedIn: false),
                              const SizedBox(height: 24),
                              const _NewsSection(),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            Container(
              padding: const EdgeInsets.only(left: 80, right: 16, top: 25, bottom: 25),
                ...
                children: [
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Siap untuk menjelajah?', style: TextStyle(fontSize: 12, color: Colors.black)),
                        SizedBox(height: 4),
                        Text('Login atau buat rekening pertama',
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.chevron_right, color: Color(0xFFCC0000), size: 24),
                  ),
                ],
              ),
            ),
            Positioned(
              left: 0, bottom: 0,
              child: Image.asset('assets/octo/octo-homepage.png', height: 85, fit: BoxFit.contain),
            ),
          ],
        ),
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: const Text('Nanti Saja', style: TextStyle(color: Color(0xFFD90002), fontWeight: FontWeight.bold, fontSize: 14)),
                ),
              ],
            ),
          ),
                      ...
                      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: [
                              const TextSpan(text: 'Selamat siang, ', style: TextStyle(fontWeight: FontWeight.w400)),
                              TextSpan(
                                text: '${DummyUser.name.toUpperCase()}!',
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              _MenuGrid(tabIndex: _selectedTab, isLoggedIn: true),
                              const SizedBox(height: 24),
        ...
        Row(
          ...
          children: List.generate(_cards.length, (i) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: _currentPage == i ? const Color(0xFF7B0000) : Colors.grey[300],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            width: 36, height: 36,
            decoration: const BoxDecoration(color: Color(0xFFFFF3F3), shape: BoxShape.circle),
            child: const Center(child: Icon(Icons.info_outline, color: Color(0xFF7B0000), size: 20)),
          ),
          ...
          const Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('CIMB Niaga Introducing, OCTO! 🥳',
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10), // ← lebih besar biar keliatan rounded
                                boxShadow: [
                                  BoxShadow(
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              balanceVisible ? 'IDR ${formatCurrency(DummyUser.ewalletBalance)}' : 'IDR •••',
                              style: const TextStyle(
                                fontSize: 18,
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: active
                    ? BoxDecoration(color: const Color(0xFFF2F2F2), borderRadius: BorderRadius.circular(25))
                    : null,
                child: Text(
                  tabs[i],
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    ...
                    color: active ? const Color(0xFF800000) : const Color(0xFFB0B0B0),
                  ),
                ),
              ),
            ),
...
class _MenuGrid extends StatelessWidget {
  ...
  static const List<List<Map<String, dynamic>>> _menus = [
    ...
    [
      ...
      {'label': 'Transaksi\nTanpa Kartu', 'icon': 'assets/icons/TransaksiTanpaKartu.svg'},
      {'label': 'Kartu\nElektronik', 'icon': 'assets/icons/KartuElektronik.svg'},
      ...
      {'label': 'Tabungan &\nDeposito', 'icon': 'assets/icons/TabunganDeposito.svg'},
    ],
    // Section 2: Transaksi
    [
      {'label': 'Transfer', 'icon': 'assets/icons/Transfer.svg'},
      ...
      {'label': 'Ringkasan Cicilan', 'icon': 'assets/icons/RingkasanCicilan.svg'},
    ...
    [
      {'label': 'Investasi', 'icon': 'assets/icons/investasi.svg'},
      {'label': 'Tabungan &\nDeposito', 'icon': 'assets/icons/TabunganDeposito.svg'},
      {'label': 'Pinjaman &\nKartu Kredit', 'icon': 'assets/icons/PinjamanKredit.svg'},
    ],
    // Section 4: Lainnya
    [
      {'label': 'Pengaturan\nKartu', 'icon': 'assets/icons/PengaturanKartu.svg'},
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Center(child: Icon(Icons.tune_rounded, color: Color(0xFF7B0000), size: 24)),
          ),
          const SizedBox(height: 8),
          const Text('Adjust\nFavorite',
              textAlign: TextAlign.center,
              maxLines: 2,
              style: TextStyle(fontSize: 12, color: Color(0xFF7B0000), fontWeight: FontWeight.w600, height: 1.2)),
        ],
      ),
    );
  }
...
class _NewsSectionState extends State<_NewsSection> {
  ...
  Widget build(BuildContext context) {
    ...
    final filtered = _articles.where((a) =>
        activeTabName == 'Semua' || a['type'] == activeTabName).toList();
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text('Berita & Promosi', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
        ),
        const SizedBox(height: 10),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
            ...
            children: List.generate(_tabs.length, (i) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: active
                      ? BoxDecoration(color: const Color(0xFFF5F5F5), borderRadius: BorderRadius.circular(25))
                      : null,
                  child: Text(
                    _tabs[i],
                    style: TextStyle(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) => GestureDetector(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(14),
                  child: Image.asset(filtered[i]['image'] as String, fit: BoxFit.cover),
                ),
              ),
            ),
          ),
